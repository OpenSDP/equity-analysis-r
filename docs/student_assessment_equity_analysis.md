...
```r
ggplot(test_data) + aes(x = rdg_ss, group = male) + 
  geom_density() + 
...
<img src="../figure/equity_CombosBoxPlots-1.png" style="display: block; margin: auto;" />
...
<img src="../figure/equity_MedianTargets-1.png" style="display: block; margin: auto;" /><img src="../figure/equity_MedianTargets-2.png" style="display: block; margin: auto;" />
...
<img src="../figure/equity_RawNumberTargets-1.png" style="display: block; margin: auto;" /><img src="../figure/equity_RawNumberTargets-2.png" style="display: block; margin: auto;" />
...
for(i in 1:n.gaps){
  ...
  clusterSE <- get_cluster_vcov(mod1, data$cluster_var)
  ...
  clusterSE <- get_cluster_vcov(mod2, data$cluster_var)
  ...
  clusterSE <- get_cluster_vcov(mod3, data$cluster_var)
  ...
  clusterSE <- get_cluster_vcov(mod4, data$cluster_var)
